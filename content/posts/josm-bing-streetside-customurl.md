...
1. Add new row with name `Bing StreetSide` and url `https://www.bing.com/maps?cp={#lat}%7E{#lon}&lvl=19.0&style=x`.\
...
1. Choose `Bing StreetSide` in Data => Select custom URL
1. Now you can see Bing StreetSide via Data => Open custom URL (Shift+H)
