...
1. Zrobić refaktor kodu. Aktualnie jest to skrypt bez sensownego podziału na funkcje i bez testów.
1. (być może) Testy poprawności geometrii relacji
...
1. To podejście może dać się zastosować dla innych miast.
