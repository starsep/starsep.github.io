...
1. Należy dodać nowy wiersz klikając z nazwą `Bing StreetSide` oraz url `https://www.bing.com/maps?cp={#lat}%7E{#lon}&lvl=19.0&style=x`.\
...
1. Należy wybrać `Bing StreetSide` w Data => Select custom URL
1. Teraz można otworzyć Bing StreetSide za pomocą Data => Open custom URL (Shift+H)
